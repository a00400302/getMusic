...
import com.example.a0040.music.Activity.AlbumActivity;
...
public class SearchListAdapter extends RecyclerView.Adapter<SearchListAdapter.mViewHolder> {
    ...
    private ArrayList<NetSBean> netList;


    public SearchListAdapter(ArrayList<NetSBean> list) {
        netList = list;
    }
...
//  TODO   直接播放
    ...
    public void onBindViewHolder(mViewHolder holder, int position) {
        holder.singer_name.setText(netList.get(position).getArtist_name());
        holder.songs_name.setText(netList.get(position).getSong_name());
